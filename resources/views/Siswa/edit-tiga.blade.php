                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <h3>Edit Data Siswa</h3>
                            <form action="{{ url('update-tiga', $sis->id)}}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                <input type="number" id="tunggakan" onkeyup="sum();" name="tunggakan" class="form-control" placeholder="Tunggakan" value="{{ $sis->tunggakan }}">
                            </div>
                            <div class="form-group">
                                <input type="number" id="pembayaran" onkeyup="sum();" name="pembayaran" class="form-control" placeholder="Pembayaran" value="{{ $sis->pembayaran }}">
                            </div>
                            <div class="form-group">
                                <input type="number" id="sisa_tunggakan" onkeyup="sum();" name="sisa_tunggakan" class="form-control" placeholder="Sisa Tunggakan" value="{{ $sis->sisa_tunggakan }}" readonly>
                            </div>
                            <div class="form-group">
